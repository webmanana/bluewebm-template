				...
				<div class="col s9">
					...
					<div class="news">
						<div class="main-leaders">
							<a class="leader" href="/администрация/главный-врач/">
								<div class="col s3">
									<div class="card">
										<div class="card-image">
										...
										<div class="card-content">
											<div class="leader-title">Тихонов Николай Петрович</div>
											<div class="leader-specialty">Главный врач</div>
										</div>
									</div>
								</div>
							</a>
							<a class="leader" href="/администрация/заместитель-главного-врача-по-амбула/">
								<div class="col s3">
									<div class="card">
										<div class="card-image">
											<img src="<?php echo get_template_directory_uri(); ?>/images/no_avatar.jpg">
							...
							<a class="leader" href="/администрация/заместитель-главного-врача-по-стацио/">
								<div class="col s3">
									<div class="card">
										<div class="card-image">
											<img src="<?php echo get_template_directory_uri(); ?>/images/no_avatar.jpg">
										...
										<div class="card-content">
											<div class="leader-title">Васильева Любовь Владимировна</div>
											<div class="leader-specialty">Заместитель главного врача по стационарной помощи</div>
										</div>
									</div>
								</div>
							</a>
							<a class="leader" href="/администрация/заместитель-главного-врача-по-эв/">
								<div class="col s3">
									<div class="card">
										<div class="card-image">
											<img src="<?php echo get_template_directory_uri(); ?>/images/no_avatar.jpg">
